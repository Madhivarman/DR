...
def saveAsCSVFile(training_set,filename):
	save = training_set.to_csv(filename+".txt",sep=' ',index=False,header=False)
	return save
...
def data_preprocessing(data):
	...
	data = data.translate(None,digits) #remove numbers from the documents
...
if __name__ == '__main__':
	...
	convert_to_df,shape = datasetPreparation(topic_names)
	saveFile = saveAsCSVFile(convert_to_df,"topics")
	#print(topic_names)
	...
	#testingdataset = saveAsCSVFile(prepare_testing_set,"trainingdataset")